...
// import { User, Mail, Settings, Shield, Bell, Calendar, MapPin, Phone, Edit3, LogOut, Camera } from "lucide-react";
...
// // Mock AuthContext для демонстрации
// const useAuth = (): AuthContextType & { login: (userData: AuthUser) => void; register: (userData: AuthUser) => void } => {
...
//   // Инициализируем userData с безопасными значениями по умолчанию
...
//   // Обновляем userData когда user становится доступен
//   useEffect(() => {
//     if (user) {
//       setUserData(prev => ({
...
//                   <div>
//                     <label htmlFor="auth-location" className="block text-sm font-medium text-gray-700 mb-1">
//                       Местоположение
//                     </label>
//                     <input
//                       id="auth-location"
...
//                   <div>
//                     <label htmlFor="auth-bio" className="block text-sm font-medium text-gray-700 mb-1">
//                       О себе
//                     </label>
//                     <textarea
//                       id="auth-bio"
...
//   const handleInputChange = (field: keyof UserData) => (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>): void => {
//     setUserData(prev => ({
//       ...prev,
...
//   const handleAuthFormChange = (field: keyof AuthUser) => (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>): void => {
//     setAuthForm(prev => ({
//       ...prev,
//       [field]: e.target.value
//     }));
...
//       const savedData = typeof window !== 'undefined' ? sessionStorage.getItem('userData') : null;
//       if (savedData) {
...
//                     />
//                   ) : (
//                     <p className="px-4 py-3 bg-gray-50 rounded-lg text-gray-800">{userData.bio}</p>
//                   )}
//                 </div>
//               </div>
//             </div>
...
//             {/* Activity Stats */}
//             <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
//               <h2 className="text-xl font-bold text-gray-800 mb-6">Статистика активности</h2>
...
//                   <span className="text-gray-800 font-medium">{userData.joinDate}</span>
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <span className="text-gray-600">Статус</span>
//                   <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-medium">Активный</span>
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <span className="text-gray-600">Тип аккаунта</span>
//                   <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs font-medium">Premium</span>
//                 </div>
//               </div>
//             </div>
...
//                   <p className="text-sm text-green-600">Двухфакторная аутентификация</p>
//                 </div>
//               </div>
//               <div className="w-full bg-green-200 rounded-full h-2">
//                 <div className="bg-green-500 h-2 rounded-full" style={{width: '85%'}}></div>
//               </div>
//               <p className="text-xs text-green-600 mt-2">Уровень безопасности: Высокий</p>
//             </div>
//           </div>
//         </div>
//       </div>
